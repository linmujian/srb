...
public class UnifiedExceptionHandler {
    ...
    public Result handleBadSqlGrammarException(BadSqlGrammarException e){
        log.error(e.getMessage(), e);
        return Result.getResult(ResponseEnum.BAD_SQL_GRAMMAR_ERROR);
    }
    ...
    public Result handleServletException(Exception e) {
        ...
        return Result.error().setMessage(ResponseEnum.SERVLET_ERROR.getMessage()).setCode(ResponseEnum.SERVLET_ERROR.getCode());
    }
}