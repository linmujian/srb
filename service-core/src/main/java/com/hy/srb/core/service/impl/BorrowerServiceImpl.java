...
import com.hy.srb.core.enums.BorrowerStatusEnum;
import com.hy.srb.core.enums.IntegralEnum;
import com.hy.srb.core.mapper.BorrowerAttachMapper;
import com.hy.srb.core.mapper.UserInfoMapper;
import com.hy.srb.core.mapper.UserIntegralMapper;
...
import com.hy.srb.core.pojo.entity.UserIntegral;
...
public class BorrowerServiceImpl extends ServiceImpl<BorrowerMapper, Borrower> implements BorrowerService {
    ...
    public void saveBorrowerVOByUserId(BorrowerVO borrowerVO, Long userId) {
        ...
        BeanUtils.copyProperties(borrowerVO, borrower); //将前端传过来的borrowerVO里的同名属性copy到borrower里
        borrower.setUserId(userId);
        borrower.setName(userInfo.getName());
        borrower.setIdCard(userInfo.getIdCard());
        borrower.setMobile(userInfo.getMobile());
        borrower.setStatus(BorrowerStatusEnum.AUTH_RUN.getStatus());//用户认证状态改为 认证中
